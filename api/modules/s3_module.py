...
class S3Handler:
    ...
    def upload_file(self, bucket_name, file_path, object_key):
        ...
        try:
            ...
            print(f"Error uploading file '{file_path}' to '{object_key}' in bucket '{bucket_name}': {e}")
            return False
    ...
    def download_file(self, bucket_name, object_key, local_file_path):
        ...
        try:
            ...
            print(f"File '{object_key}' downloaded from bucket '{bucket_name}' to '{local_file_path}'.")
            return True
        except ClientError as e:
